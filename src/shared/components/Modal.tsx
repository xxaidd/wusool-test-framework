  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className={`my-auto flex max-h-[90vh] w-full ${width} flex-col overflow-hidden rounded-2xl border border-border bg-surface shadow-2xl`}
          ...
          >
            ...
            {footer && (
              <div className="flex shrink-0 items-center justify-end gap-2 border-t border-border bg-surface-variant/50 px-5 py-3">
                {footer}
              </div>
            )}
          </motion.div>
