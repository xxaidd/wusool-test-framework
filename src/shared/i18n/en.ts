export const en = {
  ...
  map: {
    ...
    speed: "Speed (km/h)",
    speedHint:
      "Constant-speed movement along the drawn route; location updates are sent to the backend about once per second.",
    movementStarted: "Automated movement started",
    movementCompleted: "Automated movement completed",
    movementCancelled: "Automated movement cancelled",
    movementFailed: "Automated movement failed",
    locationUpdateSent: "Location update sent to backend",
